...
# <img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/logo.png" alt="Pythinker logo" width="42" align="top"> Pythinker Code
...
[![License](https://img.shields.io/badge/License-Apache--2.0-16a34a.svg?style=for-the-badge)](https://github.com/PyModel/pythinker-cli/blob/main/LICENSE)
...
[![CI](https://img.shields.io/github/actions/workflow/status/PyModel/pythinker-cli/ci-pythinker-cli.yml?branch=main&label=CI&style=for-the-badge&logo=githubactions&logoColor=white)](https://github.com/PyModel/pythinker-cli/actions/workflows/ci-pythinker-cli.yml?query=branch%3Amain)
[![Python](https://img.shields.io/badge/Python-3.12%2B-3776ab?style=for-the-badge&logo=python&logoColor=white)](https://github.com/PyModel/pythinker-cli/blob/main/pyproject.toml)
...
<img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/pythinker_cli.gif" alt="Pythinker Code terminal demo" width="860">
...
Upgrade with `pythinker update`, `pip install --upgrade pythinker-code==0.62.0`, or use the native installer for your platform from the [Releases page](https://github.com/PyModel/pythinker-cli/releases/latest).
...
<div align="center">
<img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/shell-mode.gif" alt="Shell command mode demo" width="860">
</div>
...
|---|---|---|
| **🪟 Windows** | `irm https://pythinker.com/install.ps1 \| iex` | `PythinkerSetup-0.62.0.exe` from [Releases](https://github.com/PyModel/pythinker-cli/releases/latest) |
| **<img src="https://img.shields.io/badge/-macOS-000000?style=flat-square&logo=apple&logoColor=white" alt="macOS"> / <img src="https://img.shields.io/badge/-Linux-FCC624?style=flat-square&logo=linux&logoColor=black" alt="Linux">** | `curl -fsSL https://pythinker.com/install.sh \| bash` | native tarball from [Releases](https://github.com/PyModel/pythinker-cli/releases/latest) |
| **<img src="https://img.shields.io/badge/-macOS-000000?style=flat-square&logo=apple&logoColor=white" alt="macOS"> — Homebrew** | `brew install PyModel/pythinker/pythinker-code` | auto-published Homebrew tap |
| **🐳 Docker** | `docker run --rm -it ghcr.io/pymodel/pythinker-code` | GHCR multi-arch image |
| **🪟 Windows — Scoop** | `scoop bucket add pythinker https://github.com/PyModel/scoop-pythinker && scoop install pythinker-code` | auto-published Scoop bucket |
| **❄️ Nix** | `nix run github:PyModel/pythinker-cli` | flake `apps.default` |
| **<img src="https://img.shields.io/badge/-Linux-FCC624?style=flat-square&logo=linux&logoColor=black" alt="Linux"> — system package** | Download the `.deb` or `.rpm` for your distro below | [Releases](https://github.com/PyModel/pythinker-cli/releases/latest) |
...
> `brew trust pymodel/pythinker`. The in-app updater detects the
> refusal and offers to run it for you.

**Uninstall:** `brew uninstall pythinker-code && brew untap PyModel/pythinker`.

> The tap repo is [PyModel/homebrew-pythinker](https://github.com/PyModel/homebrew-pythinker)
...
curl -LO https://github.com/PyModel/pythinker-cli/releases/download/v0.62.0/pythinker-code-0.62.0.x86_64.rpm
curl -LO https://github.com/PyModel/pythinker-cli/releases/download/v0.62.0/pythinker-code-0.62.0.x86_64.rpm.sha256
...
# Fedora / RHEL (aarch64)
curl -LO https://github.com/PyModel/pythinker-cli/releases/download/v0.62.0/pythinker-code-0.62.0.aarch64.rpm
curl -LO https://github.com/PyModel/pythinker-cli/releases/download/v0.62.0/pythinker-code-0.62.0.aarch64.rpm.sha256
...
<div align="center">
<img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/setup.png" alt="Pythinker login provider picker" width="860">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/acp-integration.gif" alt="ACP IDE integration demo" width="860">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/PyModel/pythinker-cli/main/docs/media/Architecture.webp" alt="Pythinker Code architecture diagram" width="860">
</div>
...
```sh
git clone https://github.com/PyModel/pythinker-cli.git
cd pythinker-cli
make prepare
```
...
- 📖 Start with [`CONTRIBUTING.md`](https://github.com/PyModel/pythinker-cli/blob/main/CONTRIBUTING.md)
- 🔐 See [`SECURITY.md`](https://github.com/PyModel/pythinker-cli/blob/main/SECURITY.md) for responsible disclosure
- 📜 Skim [`AGENTS.md`](https://github.com/PyModel/pythinker-cli/blob/main/AGENTS.md) for the agent design notes
...
Distributed under the **Apache-2.0 License**. See [`LICENSE`](https://github.com/PyModel/pythinker-cli/blob/main/LICENSE) for the full text and [`NOTICE`](https://github.com/PyModel/pythinker-cli/blob/main/NOTICE) for attributions.
...
[🐙 GitHub](https://github.com/PyModel/pythinker-cli) &nbsp;·&nbsp;
